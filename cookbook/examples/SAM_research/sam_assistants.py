...
assistant = Assistant(
    ...
    expected_output=dedent(
            ...
            *US Market News*
            ...
            {provide summary from article regarding US market news}

            *Asia Market News*
            {Bursa Asia mengalami penguatan/penurunan X.XX%... }
            {provide summary from article regarding Asia market news}

            *Indonesian Market News*
            {Kemarin, JCI mengalami penurunan X.XX%... }
            {provide summary from article regarding Indonesian market news}
